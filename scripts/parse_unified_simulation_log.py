...
print(len(master_files), len(opencv_files), len(laneVP_files))

for file_master, file_openCV, file_laneVP in zip(master_files, opencv_files, laneVP_files):
    ...
    if master_detections.empty or Opencv_detections.empty or laneVP_detections.empty:
        continue
